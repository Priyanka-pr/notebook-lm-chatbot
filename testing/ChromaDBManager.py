'''
https://api.python.langchain.com/en/latest/_modules/langchain_community/vectorstores/chroma.html#Chroma
https://api.python.langchain.com/en/latest/_modules/langchain_openai/embeddings/base.html#OpenAIEmbeddings
'''
